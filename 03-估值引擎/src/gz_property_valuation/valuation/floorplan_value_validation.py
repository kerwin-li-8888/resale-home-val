...
from gz_property_valuation.ingest.floorplan_ocr_parse import parse_ocr_run_directory
...
def rebuild_annotation_table(
    ...
    """
    with tempfile.TemporaryDirectory(prefix="gz_property_valuation-fvv-rebuild-") as td:
        tmp = Path(td)
