...
from gz_property_valuation.catalog import SnapshotRef
...
def data_stage(
    ...
    *,
    ...
    # WP5-E 验收③ + norm-v2：未匹配 / 低置信 / 外区括注排除三分册登记
    # （不静默归并），从两表事件的 community 列分类收集。
    ...
    report = build_quality_report(
        ...
        source_id=source_id,
        fetched_at=fetched_at,
        unmatched_conflicts=unresolved["unmatched"],
