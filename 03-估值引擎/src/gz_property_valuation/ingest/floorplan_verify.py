...
本模块实现 ``gz_property_valuation floorplan verify`` 与 ``gz_property_valuation floorplan status`` 的核心逻辑：
...
from gz_property_valuation.ingest.floorplan_asset import FloorplanAssetRun
...
def verify_run(
    ...
    *,
    ...
    from gz_property_valuation.ingest.floorplan_transcribe import read_word_table
...
def replay_run_annotations(
    ...
    不伪造词条。
    """
    from gz_property_valuation.ingest.floorplan_ocr_parse import parse_response_body
    from gz_property_valuation.ingest.floorplan_transcribe import transcribe_words
...
def full_asset_auto_gates(
    ...
    *,
    ...
    from gz_property_valuation.ingest.floorplan_transcribe import cross_run_field_key
...
def auto_accept_room_claim_audit(
    ...
    from gz_property_valuation.ingest.floorplan_golden_compare import (
        is_confirmed_golden,
...
def run_offline_replay_evaluation(
    ...
    *,
    ...
    if golden_csv is not None:
        from gz_property_valuation.ingest.floorplan_golden_compare import (  # 延迟导入防环
