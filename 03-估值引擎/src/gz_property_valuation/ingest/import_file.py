...
WP4-A (DATA-004): ``gz_property_valuation ingest file --input <path> --source <src> --dataset
...
from gz_property_valuation.ingest.snapshots import SnapshotResult, write_raw_snapshot
...
def resolve_source_dir(token: str) -> str:
    ...
    create a partition that ``gz_property_valuation catalog`` cannot relate to a registry source.
    """
