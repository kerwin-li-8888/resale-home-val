...
从 :mod:`gz_property_valuation.entities.candidates`（候选小区名录-V0.1.md 的
...
候选（:data:`~gz_property_valuation.entities.candidates.ID_PENDING_EXCLUDED`）
...
from gz_property_valuation.contract.models import Community, CoordinateSystem
from gz_property_valuation.entities.candidates import CandidateCommunity, candidates_all
